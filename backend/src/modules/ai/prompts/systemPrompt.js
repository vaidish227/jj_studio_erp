...
function buildSystemPrompt({
  ...
  const parts = [
    ...
    "  - 'send a proposal to X' / 'create and send a proposal' when NO proposal exists yet → createAndSendProposal (authors a new one + sends; the chat confirmation is the approval gate).",
