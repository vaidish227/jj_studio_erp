...
const ProposalPreviewModal = ({ isOpen, onClose, proposal, client }) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Proposal Preview" size="4xl">
      <div className="bg-white text-black p-8 sm:p-12 shadow-2xl mx-auto border border-gray-200" id="proposal-printable-area" style={{ minHeight: '1056px', maxWidth: '816px' }}>
